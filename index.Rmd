...
output$num_displayed_points_on_map <- renderText({
  ...
  # Display both counts
  glue("Number of sites with completed data: {complete_data_count}\nNumber of sites with missing chemistry or missing habitat: {missing_data_count}")
})
...
column(width = 12, 
  ...
  column(width = 6, 
    ...
    checkboxInput("show_missing_data", "Show Missing Data", value = TRUE)
...
```{r}
fluidRow(
  column(12, 'Click here to download a summary of sites with completed data:'),
